...
const HonorCode = ({ courseId }) => {
    ...
    return (
        <Alert variant="light" aria-live="off">
            <h4 aria-level="3">
                {siteName} {intl.formatMessage(messages["learn.honorCode.name"])}
            </h4>

            <p>
                <FormattedMessage
                    id="learn.honorCode.content"
                    defaultMessage="Sự trung thực và tính chính trực học thuật rất quan trọng đối với {siteName} và các tổ chức cung cấp khóa học và chương trình trên trang web {siteName}. Bằng cách nhấp vào 'Tôi đồng ý' bên dưới, tôi xác nhận rằng tôi đã đọc, hiểu và sẽ tuân thủ {link} cho trang web {siteName}."
                    values={{
                        siteName,
