...
const UpgradeFootnote = ({ deadline, href }) => {
    ...
    const expirationDate = <FormattedDate day="numeric" month="long" year="numeric" value={deadline} />;
        ...
        <Footnote
            ...
            text={
                <FormattedMessage
                    ...
                    defaultMessage="Quyền truy cập vào khóa học này và tài liệu của nó có sẵn trên bảng điều khiển của bạn cho đến {expirationDate}. Để gia hạn quyền truy cập, {upgradeLink}."
                    values={{
                        expirationDate,
                        upgradeLink,
                    }}
