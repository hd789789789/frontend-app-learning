...
const messages = defineMessages({
    recommendationsHeading: {
        ...
        defaultMessage: "Tiếp tục xây dựng kỹ năng của bạn với những khóa học này!",
    },
    ...
    listJoin: {
        ...
        description:
            "Joining mark or word for a list of items, use the {sp} placeholder to include space before the joining word",
    ...
    browseCatalog: {
        ...
        defaultMessage: "Khám phá thêm khóa học",
    },
    loadingRecommendations: {
        ...
        defaultMessage: "Đang tải đề xuất",
    },
});
...
const CourseCard = ({ original: { title, image, owners, marketingUrl, onClick } }) => {
    ...
    const subtitle = (
        <FormattedMessage
            ...
            defaultMessage="Trường học và Đối tác"
        >
            {(text) => (
                <>
    ...
    return (
        <div role="group" aria-label={title}>
            <Hyperlink destination={marketingUrl} className="text-decoration-none" onClick={onClick}>
...
const CourseRecommendations = ({ variant }) => {
    const intl = useIntl();
    const { courseId, recommendationsStatus } = useSelector((state) => ({
