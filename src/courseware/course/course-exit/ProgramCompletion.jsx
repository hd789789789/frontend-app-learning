...
const ProgramCompletion = ({ progress, title, type, url }) => {
    ...
    const programLink = (
        <Hyperlink style={{ textDecoration: "underline" }} destination={url} className="text-reset">
                ...
                <div className="col order-1 order-md-0 pl-0 pr-0 pr-md-5">
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage="Để xem trạng thái chứng chỉ của bạn, hãy kiểm tra phần Chương trình trong {programLink} của bạn."
                            values={{ programLink }}
                    ...
                    {type === "microbachelors" && (
                        <>
                            ...
                            <Button
                                ...
                                href={`${getConfig().CREDENTIALS_BASE_URL}/records`}
                            >
                    ...
                    {type === "micromasters" && (
                        <p>
                            ...
                            <Hyperlink
                                ...
                                }/hc/en-us/articles/360010346853-Does-a-Micromasters-certificate-count-towards-the-online-Master-s-degree-`}
                                className="text-reset"
                            >
