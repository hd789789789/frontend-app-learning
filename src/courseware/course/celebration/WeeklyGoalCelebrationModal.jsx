...
const WeeklyGoalCelebrationModal = ({ courseId, daysPerWeek, isOpen, onClose, ...rest }) => {
    const intl = useIntl();
    ...
    return (
        <StandardModal
            ...
            isOpen={isOpen}
            onClose={onClose}
            title={<p className="h2 text-center mr-n5 pt-4">{intl.formatMessage(messages.goalMet)}</p>}
            {...rest}
        >
            <>
                <div className="text-center px-3">
                    <FormattedMessage
                        ...
                        defaultMessage="Chúc mừng, bạn đã đạt được mục tiêu học tập {nTimes} lần mỗi tuần."
                ...
                <div className="py-3 pl-3 bg-light-300 small d-inline-flex">
                    <Icon src={Lightbulb} className="mr-2" style={{ height: "21px", width: "22px" }} />
                    <div>
                        <FormattedMessage
