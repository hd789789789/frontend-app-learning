    ...
    <div className="flex-grow-1">
        <PageLoading
            srMessage={
                <FormattedMessage
                    ...
                    defaultMessage="Đang điều hướng..."
                />
            }
        />
        ...
        <Routes>
            <Route
                ...
                element={
                    <DecodePageRoute>
                        <RedirectPage pattern="/courses/:courseId/survey" mode={REDIRECT_MODES.SURVEY_REDIRECT} />
                    </DecodePageRoute>
                }
            />
            <Route
                ...
                element={
                    <PageWrap>
                        <RedirectPage pattern="/dashboard" mode={REDIRECT_MODES.DASHBOARD_REDIRECT} />
                    </PageWrap>
                }
            />
            <Route
                ...
                element={
                    <PageWrap>
                        <RedirectPage mode={REDIRECT_MODES.ENTERPRISE_LEARNER_DASHBOARD_REDIRECT} />
                    </PageWrap>
                }
            />
            <Route
            ...
            <Route
                ...
                element={
                    <DecodePageRoute>
                        <RedirectPage pattern="/course/:courseId/home" mode={REDIRECT_MODES.HOME_REDIRECT} />
                    </DecodePageRoute>
                }
            />
        </Routes>
