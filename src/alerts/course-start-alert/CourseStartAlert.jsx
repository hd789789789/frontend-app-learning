        ...
        return (
            <Alert variant="info" icon={Info}>
                <FormattedMessage
                    ...
                    defaultMessage="Khóa học bắt đầu {timeRemaining} vào lúc {courseStartTime}."
        ...
        <Alert variant="info" icon={Info}>
            <strong>
                <FormattedMessage
                    ...
                    defaultMessage="Khóa học bắt đầu {timeRemaining} vào ngày {courseStartDate}."
            ...
            <FormattedMessage
                ...
                defaultMessage="Đừng quên thêm lời nhắc vào lịch!"
