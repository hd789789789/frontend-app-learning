...
const Tabs = ({ children, className, ...attrs }) => {
    const [indexOfLastVisibleChild, containerElementRef, invisibleStyle, overflowElementRef] =
    ...
    const tabChildren = useMemo(() => {
        ...
        const overflowChildren = childrenArray
            .slice(indexOfOverflowStart)
    ...
    return (
        <nav {...attrs} className={classNames("nav flex-nowrap", className)} ref={containerElementRef}>
            {tabChildren}
        </nav>
    );
};
