    ...
    <Card className="mb-4 shadow-sm">
      ...
      <Card.Body>
        <div className="row">
          ...
          <div className="display-4 font-weight-bold text-primary">{formatInteger(rank)}</div>
            <div className="text-muted">Hạng hiện tại</div>
          </div>
          <div className="col-md-4 text-center border-right">
            <div className="display-4 font-weight-bold text-success">{formatInteger(totalStudents)}</div>
            <div className="text-muted">Tổng học viên</div>
          </div>
          <div className="col-md-4 text-center">
            <div className="display-4 font-weight-bold text-info">
              <span className="mr-2">📈</span>
              {formatDecimal(percentile ?? 0, 1)}%
            </div>
        ...
        <div className="mt-3 text-center">
            ...
            Bạn đang học tốt hơn {formatDecimal(percentile ?? 0, 1)}% học viên trong khóa học này
          </small>
        </div>
      </Card.Body>
    </Card>
