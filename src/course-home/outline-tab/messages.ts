...
const messages = defineMessages({
    allDates: {
        ...
        defaultMessage: "Xem tất cả ngày tháng khóa học",
    ...
    hiddenSequenceLink: {
        ...
        defaultMessage:
            "Các phần phụ không thể điều hướng giữa nhau, chỉ có thể truy cập thông qua liên kết của chúng.",
    ...
    goalReminderDetail: {
        ...
        defaultMessage: "Nếu chúng tôi nhận thấy bạn chưa đạt được mục tiêu, chúng tôi sẽ gửi email nhắc nhở cho bạn.",
    ...
    intenseGoalButtonText: {
        ...
        defaultMessage: "5 ngày mỗi tuần",
        description: "Text shown for intense goal button",
    },
    intenseGoalButtonTitle: {
        id: "learning.outline.goalButton.intense.title",
        defaultMessage: "Chuyên sâu",
        description:
            "A very short description of the most intensive option of three learning goals, Casual, Regular and Intense",
    },
    learnMore: {
    ...
    regularGoalButtonText: {
        ...
        defaultMessage: "3 ngày mỗi tuần",
    ...
    regularGoalButtonTitle: {
        ...
        description:
            "A very short description of the middle option of three learning goals, Casual, Regular and Intense",
    },
    resumeBlurb: {
        id: "learning.outline.resumeBlurb",
        defaultMessage: "Tiếp tục từ nơi bạn dừng lại",
        description:
            "Text describing to the learner that they can return to the last section they visited within the course.",
    },
    resume: {
    ...
    setGoal: {
        ...
        defaultMessage:
            "Để bắt đầu, hãy đặt mục tiêu khóa học bằng cách chọn tùy chọn bên dưới phù hợp nhất với kế hoạch học tập của bạn.",
        description: "In indicate to learner how to set or use the goal reminder service",
    },
    setGoalReminder: {
        id: "learning.outline.setGoalReminder",
        defaultMessage: "Đặt lời nhắc mục tiêu",
    ...
    setLearningGoalButtonScreenReaderText: {
        ...
        defaultMessage: "Đặt phong cách mục tiêu học tập.",
    ...
    setWeeklyGoalDetail: {
        ...
        defaultMessage: "Đặt mục tiêu giúp bạn có động lực hoàn thành khóa học. Bạn luôn có thể thay đổi sau.",
    ...
    startBlurb: {
        ...
        defaultMessage: "Bắt đầu khóa học của bạn hôm nay",
    },
    tools: {
        id: "learning.outline.tools",
        defaultMessage: "Công cụ khóa học",
        description:
            "Headline for the (course tools) section in course outline. course tool might include links to course bookmarks, financial assistance...etc",
    },
    upgradeButton: {
    ...
    upgradeTitle: {
        ...
        defaultMessage: "Theo đuổi chứng chỉ đã xác minh",
        description: "Upgrade title",
    },
    welcomeMessage: {
        id: "learning.outline.welcomeMessage",
        defaultMessage: "Thông điệp chào mừng",
    },
    ...
    otherCourseApprovedProctoringStatus: {
        ...
        defaultMessage: "Đã phê duyệt trong khóa học khác",
        description:
            "Label to indicate that the proctortrack onboarding exam is verified based on taking onboarding exam on another course",
    },
    ...
    proctoringCurrentStatus: {
        ...
        defaultMessage: "Tình trạng hướng dẫn hiện tại:",
    ...
    notStartedProctoringMessage: {
        ...
        defaultMessage: "Bạn chưa bắt đầu bài kiểm tra hướng dẫn của mình.",
    ...
    startedProctoringMessage: {
        ...
        defaultMessage: "Bạn đã bắt đầu bài kiểm tra hướng dẫn của mình.",
    ...
    submittedProctoringMessage: {
        ...
        defaultMessage: "Bạn đã nộp bài kiểm tra hướng dẫn của mình.",
    ...
    verifiedProctoringMessage: {
        ...
        defaultMessage: "Bài kiểm tra hướng dẫn của bạn đã được phê duyệt trong khóa học này.",
    ...
    rejectedProctoringMessage: {
        ...
        defaultMessage: "Bài kiểm tra hướng dẫn của bạn đã bị từ chối. Vui lòng thử lại hướng dẫn.",
    ...
    errorProctoringMessage: {
        ...
        defaultMessage: "Đã xảy ra lỗi trong bài kiểm tra hướng dẫn của bạn. Vui lòng thử lại hướng dẫn.",
    ...
    otherCourseApprovedProctoringMessage: {
        ...
        defaultMessage: "Bài kiểm tra hướng dẫn của bạn đã được phê duyệt trong khóa học khác.",
        description:
            "The text that explain the meaning of (approved in another course) label of the proctortrack onboarding exam",
    },
    otherCourseApprovedProctoringDetail: {
        id: "learning.proctoringPanel.detail.otherCourseApproved",
        defaultMessage:
            "Nếu thiết bị của bạn đã thay đổi, chúng tôi khuyên bạn nên hoàn thành bài kiểm tra hướng dẫn của khóa học này để đảm bảo rằng thiết lập của bạn vẫn đáp ứng các yêu cầu giám sát.",
        description:
            "The text that recommend an action when the status of the proctortrack onboarding exam is (approved in another course)",
    },
    expiringSoonProctoringMessage: {
        id: "learning.proctoringPanel.message.expiringSoon",
        defaultMessage:
            "Hồ sơ hướng dẫn của bạn đã được phê duyệt. Tuy nhiên, tình trạng hướng dẫn của bạn sắp hết hạn. Vui lòng hoàn thành hướng dẫn lại để đảm bảo bạn có thể tiếp tục làm bài kiểm tra giám sát.",
        description:
            "The text that recommend an action when the status of the proctortrack onboarding exam is (expiring soon)",
    },
    expiredProctoringMessage: {
        id: "learning.proctoringPanel.message.expired",
        defaultMessage:
            "Tình trạng hướng dẫn của bạn đã hết hạn. Vui lòng hoàn thành hướng dẫn lại để tiếp tục làm bài kiểm tra giám sát.",
        description:
            "The text that recommend an action when the status of the proctortrack onboarding exam is (expired)",
    },
    proctoringPanelGeneralInfo: {
        id: "learning.proctoringPanel.generalInfo",
        defaultMessage: "Bạn phải hoàn thành quy trình hướng dẫn trước khi làm bất kỳ bài kiểm tra giám sát nào.",
        description:
            "It indicate key and important fact to learner about the importance of taking proctortrack onboarding exam",
    },
    ...
    proctoringPanelGeneralTime: {
        ...
        defaultMessage: "Việc xem xét hồ sơ hướng dẫn có thể mất hơn 2 ngày làm việc.",
        description:
            "This text explain for how long the (in review) status of the proctortrack onboarding exam might remain",
    },
    proctoringOnboardingButton: {
        id: "learning.proctoringPanel.onboardingButton",
        defaultMessage: "Hoàn thành hướng dẫn",
    ...
    proctoringOnboardingPracticeButton: {
        ...
        defaultMessage: "Xem bài kiểm tra hướng dẫn",
        description:
            "The text that appears on onboarding exam while its not released, so learners can take or view it as a practice",
    },
    proctoringOnboardingButtonNotOpen: {
        id: "learning.proctoringPanel.onboardingButtonNotOpen",
        defaultMessage: "Hướng dẫn mở: {releaseDate}",
    ...
    proctoringReviewRequirementsButton: {
        ...
        description:
            "Anchor text for button which redirect leaner to doc or a detailed page about proctortrack onboarding exam",
    },
    proctoringOnboardingButtonPastDue: {
        id: "learning.proctoringPanel.onboardingButtonPastDue",
        defaultMessage: "Hướng dẫn quá hạn",
        description:
            "Text that show when the deadline of proctortrack onboarding exam has passed, it appears on button that start the onboarding exam however for this case the button is disabled for obvious reason",
    },
    sequenceDueDate: {
        id: "learning.outline.sequence-due-date-set",
        defaultMessage: "{description} hạn chót {assignmentDue}",
