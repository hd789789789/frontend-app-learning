...
const CourseEndAlert = ({ payload }) => {
    const { description, endDate, userTimezone } = payload;
    ...
    if (delta < DAY_MS) {
        ...
        msg = (
            <FormattedMessage
                ...
                defaultMessage="Khóa học này sẽ kết thúc {timeRemaining} vào lúc {courseEndTime}."
        ...
        msg = (
            <FormattedMessage
                ...
                defaultMessage="Khóa học này sẽ kết thúc {timeRemaining} vào ngày {courseEndDate}."
