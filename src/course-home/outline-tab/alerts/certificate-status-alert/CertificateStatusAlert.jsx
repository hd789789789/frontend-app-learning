            ...
            alertProps.body = (
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage="Khóa học này kết thúc vào {courseEndDateFormatted}. Điểm cuối kỳ và bất kỳ chứng chỉ nào đã đạt được dự kiến sẽ có sẵn sau {certificateAvailableDate}."
                        values={{
